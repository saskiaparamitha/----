 ...
 * Deskripsi : Berisi main driver dalam class MTitik
...
public class MTitik {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("Absis dari T1 = "+T1.absis+", Ordinat dari T1 = "+T1.ordinat+"");
        System.out.println("\nAbsis dari T2 = "+T2.absis+", Ordinat dari T2 = "+T2.ordinat+"");
        System.out.println("Absis dari T3 = "+T3.absis+", Ordinat dari T3 = "+T3.ordinat+"");
